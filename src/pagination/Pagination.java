...
public class Pagination extends JPanel {
    ...
    private void changePage(int current, int totalPage) {
        ...
        removeAll();
        refresh();
        JButton cmdPrev = paginationItemRender.createPaginationItem("Précedent", true, false, page.isPrevious());
        ...
        JButton cmdNext = paginationItemRender.createPaginationItem("Suivant", false, true, page.isNext());
